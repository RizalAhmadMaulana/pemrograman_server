...
api_v2 = NinjaAPI(
    ...
    version="2.0.0",
    throttle=SimpleRateThrottle(),   # â† aktif
    )
...
# 1ï¸âƒ£ List users (paginated + optional search)
...
# 2ï¸âƒ£ My Courses (logged in user)
...
# 5ï¸âƒ£ List comments for a content (paginated)
